...
INSERT INTO `Brand` VALUES (1,'Toyota','Toyota Vios 1.5 Entry My19 วีออส',2019,'รถเก๋ง 4 ประตู','เครื่องยนต์ 1,496 cc., ขับเคลื่อนล้อหน้า, เกียร์ออโต้แบบ CVT (พร้อม Sequential Shift)','เบนซิน 95, เบนซิน 91, แก๊สโซฮอล์ 95 (E10), แก๊สโซฮอล์ 91, เบนซิน E20, เบนซิน E85');
...
INSERT INTO `Car` VALUES ('qqqqqq','เขียว','1995-04-19',1,1254654557777),('ดด1234','green','1995-05-19',1,1254654557777);
...
INSERT INTO `Case` VALUES (1,'ชนคนตาย','อ๊อฟ เด็กดอก',14544,'ดด1234',1,'2019-04-26 15:31:12');
...
INSERT INTO `PoliceStation` VALUES (1,'สถานี่ตำรวจภูธรชลบุรี','ไทย',20130,3653456,'14/11 ม.2 ต.แสนสุข อ.เมือง');
...
INSERT INTO `Users` VALUES (1254654557777,'Timmy','jrtt','1995-05-19','thai','ชลบุรี',20130,'14/11 ม.2 ต.แสนสุข อ.เมือง');
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000000_create_users_table',1),(2,'2014_10_12_100000_create_password_resets_table',1),(3,'2019_03_24_110148_create_table_brand',2),(4,'2019_03_24_110836_create_table_user',2),(5,'2019_04_24_154650_create_table_car',2),(6,'2019_04_25_103254_create_table_policestation',2),(7,'2019_04_25_110331_create_table_case',2);
...
LOCK TABLES `users` WRITE;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` VALUES (1,'fsdf','opp_1656@hotmail.com',NULL,'$2y$10$ejAlBSeDeIxQj2u2S4Apo.8MeQT6ZDvNi8ccoLofA4sBEUi06jUUW',NULL,'2019-04-26 15:40:29','2019-04-26 15:40:29');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-04-26 21:33:40
